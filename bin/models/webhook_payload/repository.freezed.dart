...
mixin _$Repository {
  ...
  int? get pushedAt => throw _privateConstructorUsedError;
...
abstract class $RepositoryCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'pushed_at') int? pushedAt,
...
class _$RepositoryImpl implements _Repository {
  _$RepositoryImpl(
      ...
      this.stargazers,
      @JsonKey(name: 'master_branch') this.masterBranch})
      : _topics = topics;
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.stargazers, stargazers) || other.stargazers == stargazers) &&
            (identical(other.masterBranch, masterBranch) || other.masterBranch == masterBranch));
  }
...
abstract class _Repository implements Repository {
  factory _Repository(
          ...
          @JsonKey(name: 'pushed_at') final int? pushedAt,
          ...
          final int? stargazers,
          @JsonKey(name: 'master_branch') final String? masterBranch}) =
      _$RepositoryImpl;
